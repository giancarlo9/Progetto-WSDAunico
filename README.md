...
Cliente (Customer): Stores client contact details and links to multiple vehicles.

Veicolo (Vehicle): Tracks license plates, models, and specifications linked to specific clients.

Intervento (Intervention): Records maintenance descriptions, notes, and progress states (Stato).

Utente (User): Manages staff credentials and role assignments (Ruolo).
...
Access the application locally in your browser at http://localhost:8080.
